...
export function wrapPasswordResetEmail({ code }) {
  return `<!DOCTYPE html>
<html>
<head><meta charset="utf-8"></head>
<body style="margin:0;padding:0;background:#0c0b0a;font-family:Georgia,'Times New Roman',serif;">
  <div style="max-width:600px;margin:0 auto;padding:32px 24px;color:#f5f0e8;">
    <p style="color:#c9a962;letter-spacing:0.3em;font-size:14px;margin:0 0 24px;">MAREA</p>
    <p style="font-size:15px;line-height:1.7;">Your password reset code is:</p>
    <p style="font-size:28px;letter-spacing:0.3em;color:#c9a962;margin:24px 0;text-align:center;">${code}</p>
    <p style="font-size:13px;color:#8a8278;">This code expires in 1 hour.</p>
  </div>
</body>
</html>`
}
