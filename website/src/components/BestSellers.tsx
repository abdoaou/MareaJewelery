...
import { loadBestSellerProducts } from '../utils/homeCatalog'
...
export default function BestSellers() {
  ...
  return (
    <section id="best-sellers" className="bg-marea-bg-soft py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-16 flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-end">
          ...
          >
            <p className="section-label mb-4">{t('sections.bestSellers.label')}</p>
